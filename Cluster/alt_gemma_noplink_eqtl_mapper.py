...
snpdic = {}
snpbed = open('/mnt/gluster/data/internal_supp/hutt_ipsc/Genotypes/hutt.imputed.73subset.created.bed','r')
for line in snpbed:
...
if regressPCs:
	expressed = matrix_reader('/mnt/gluster/data/internal_supp/hutt_ipsc/GEMMAFiles/hutt.DConly.ordered.bimbam',dtype='float')
...
if not regressPCs:
	cover = ('cp ' + '/mnt/gluster/data/internal_supp/hutt_ipsc/GEMMAFiles/hutt.DConly' + gccor + covcor + '.ordered.pc' + str(pcs) + ' ' + currfiles + '.pcs.txt')
	ifier(cover)
