...
genos = open('/mnt/gluster/data/internal_supp/hutt_ipsc/Genotypes/hutt.imputed.73subset.bim','r')
...
outfile = open('/mnt/gluster/data/internal_supp/hutt_ipsc/GEMMAFiles/hutt.imputed.1Mb.mastercols.txt','w')
chroutfile = open('/mnt/gluster/data/internal_supp/hutt_ipsc/GEMMAFiles/hutt.imputed.1Mb.chrmspecific.mastercols.txt','w')
